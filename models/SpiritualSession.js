...
const spiritualSessionSchema = new mongoose.Schema({
  ...
  emotion: {
    type: String,
    enum: ['happy', 'sad', 'angry', 'afraid', 'loved', 'surprised', 'calm', 'disgusted', 'stressed', 'anxious', 'peaceful', 'grateful', 'hopeful', 'loving', 'serene', 'focused', 'energized', 'centered', 'mindful', 'devoted', 'elevated', 'reverent']
  },
  chantCount: {
    type: Number,
    default: 0
