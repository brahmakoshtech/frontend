...
export default {
  ...
  setup() {
    ...
    const emotions = [
      ...
      { emoji: '🧘', label: 'Centered', value: 'centered' },
          ...
          clips.value = [
            {
              ...
              description: 'In silence, we find our truest self. Discover profound peace in stillness.',
              type: 'silence'
            },
            {
              _id: '2',
              title: 'Mindful Quietude',
              description: 'Embrace the power of silence and let your mind find its natural state of peace.',
              type: 'silence'
            },
            {
              _id: '3',
              title: 'Inner Stillness',
              description: 'Connect with your inner wisdom through the practice of conscious silence.',
              type: 'silence'
            }
          ];
        }
        ...
        clips.value = [
          {
            _id: '1',
            title: 'Silent Contemplation',
            description: 'In silence, we find our truest self.',
            type: 'silence'
          },
          {
            _id: '2',
            title: 'Mindful Quietude',
            description: 'Embrace the power of silence and peace.',
            type: 'silence'
          }
        ];
      } finally {
        ...
        {!isSessionActive.value ? (
          <>
            ...
            <div class="silence-content">
              ...
              <p>In silence, we find our truest self. Discover profound peace in stillness.</p>
          ...
          <div class="session-screen">
            <div class="session-card">
              <h2 style={{ color: '#9ca3af', fontSize: '1.5rem', fontWeight: '600', marginBottom: '0.5rem' }}>Silence in Progress</h2>
              <p style={{ color: '#9ca3af', fontSize: '0.9rem', marginBottom: '1rem', opacity: 0.9 }}>Feeling: {selectedEmotion.value}</p>
              
              <div class="silence-circle">
                <div class="silence-counter">{formatTime(sessionTime.value)}</div>
              </div>
              
              <p style={{ color: '#9ca3af', fontSize: '0.9rem', marginTop: '1rem', marginBottom: '2rem' }}>Target: {targetDuration.value} minutes</p>
          ...
          <div class="modal-overlay">
            <div class="session-modal">
              ...
              <div class="modal-actions">
                ...
                <button class="start-btn" onClick={startSession}>Start Silence</button>
              </div>
            </div>
          </div>
        )}
          ...
          <div class="reward-modal">
            <div class="reward-content">
              ...
              <div style={{ fontSize: '1.2rem', marginBottom: '1rem', opacity: 0.9 }}>
                You practiced silence for {targetDuration.value} minutes
              </div>
