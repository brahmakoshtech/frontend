          ...
          <div class="col-12">
            <div class="d-flex align-items-center gap-3 mb-4">
              <button class="btn btn-outline-secondary btn-sm rounded-pill px-3" onClick={goBack}>
                <ArrowLeftIcon style={{ width: '1rem', height: '1rem' }} class="me-1" />Back
              </button>
              <div>
                <h1 class="mb-0 fw-bold">🙏 Prayer & Worship</h1>
                <p class="text-muted mb-0">Daily prayers and devotional practices</p>
              </div>
            </div>
            <div class="card border-0 shadow-sm rounded-4">
              <div class="card-body p-5 text-center">
                <div class="display-1 mb-3">🙏</div>
                <h3 class="fw-bold mb-3">Prayer Practice</h3>
                <p class="text-muted">Coming soon - Sacred prayer experience</p>
>>>>>>> c736c14b8f58dedbba903a2cfa06fd5828862d3c
              </div>
            </div>
          </div>
