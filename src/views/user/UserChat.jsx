...
export default {
  ...
  setup() {
    ...
    // User astrology data (for initial request)
    ...
    // Select partner and show astrology form
    const selectPartner = (partner) => {
      ...
      if (existingConv) {
        ...
        // Show astrology form for new conversation
    ...
    return () => (
      <div style="height: calc(100vh - 64px); background-color: #f9fafb;">
        ...
        {showAstrologyForm.value && (
          <div style="position: fixed; inset: 0; background-color: rgba(0,0,0,0.5); z-index: 50; display: flex; align-items: center; justify-content: center; padding: 16px;">
            <div style="background-color: white; border-radius: 12px; max-width: 500px; width: 100%; max-height: 90vh; overflow-y: auto; padding: 24px;">
              <h2 style="font-size: 20px; font-weight: 600; color: #111827; margin: 0 0 16px 0;">
                Share Your Birth Details
              </h2>
              <p style="color: #6b7280; font-size: 14px; margin-bottom: 24px;">
                Help the astrologer provide accurate guidance by sharing your birth information.
              </p>
              ...
              <div style="display: flex; flex-direction: column; gap: 16px;">
                <div>
                  ...
                  <input
                    ...
                    style="width: 100%; padding: 10px 12px; border: 1px solid #d1d5db; border-radius: 6px; outline: none;"
              ...
              <div style="display: flex; gap: 12px; margin-top: 24px;">
                <button
                  ...
                  style="flex: 1; padding: 12px; border: 1px solid #d1d5db; background-color: white; color: #374151; border-radius: 8px; font-weight: 500; cursor: pointer;"
                >
                  Cancel
                </button>
                <button
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 24px;">
                  {partners.value.map(partner => (
                    ...
                    >
                      ...
                      <button
                        style={`width: 100%; margin-top: 16px; padding: 12px; background-color: #6366f1; color: white; border: none; border-radius: 8px; font-weight: 500; cursor: pointer; ${
                          partner.canAcceptConversation === false ? 'opacity: 0.5;' : ''
                        }`}
                ...
                {conversations.value.length === 0 ? (
                  ...
                  conversations.value.map(conv => (
                    <div
                      ...
                      style={`padding: 16px; border-bottom: 1px solid #f3f4f6; cursor: pointer; ${
                    ...
                    {selectedConversation.value.status === 'pending' ? (
                      ...
                      <div style="display: flex; gap: 12px; align-items: center;">
                        ...
                        <button
                          ...
                          style={`padding: 12px 24px; background-color: #6366f1; color: white; border: none; border-radius: 24px; font-weight: 500; cursor: pointer; ${
