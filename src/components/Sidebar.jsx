...
export default {
  ...
  setup() {
    ...
    const clientMenu = [
      ...
      { path: '/client/agents', label: 'Agents', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2l3 6 6 .9-4.5 4.3 1.1 6.3L12 17.8 6.4 19.5l1.1-6.3L3 8.9 9 8z"/><path d="M12 11v3"/><path d="M12 18h.01"/></svg> },
